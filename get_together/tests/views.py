...
class ViewTests(TestCase):
    ...
    # @mock.patch("imagekit.models.ImageSpecField.url", "/static/images/team_placeholder.png")
    # def test_remove_event_photo(self):
    #     member = mommy.make(Member, team=self.team, user=self.userProfile, role=Member.NORMAL)
    #     photo = mommy.make(EventPhoto, event=self.event, uploader=self.userProfile, src='../static/images/team_placeholder.png')
